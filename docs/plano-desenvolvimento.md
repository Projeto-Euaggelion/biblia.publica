...
### 1.1 Corrigir referências antigas à versão `tb` na documentação ([#3](https://github.com/Projeto-Euaggelion/biblia.publica/issues/3))
- **Tamanho:** P
- **Descrição:** `docs/estrutura-arquivos/estrutura-json.md` e `estrutura-xml.md` ainda citam a versão `tb` (Tradução Brasileira) como exemplo, mas ela não existe mais em `versoes/` (as versões atuais são `blivre`, `jfaal`, `nt-a1819a`, `nva`). Atualizar os exemplos para uma versão real existente. A remoção da versão do projeto e do histórico de commits foi uma decisão motivada pela incerteza se o texto adicionado ao projeto é da versão em domínio público ou a versão atualizada.
- **Critérios de aceite:** nenhuma menção a `tb` nos docs de estrutura; exemplos de árvore de diretórios refletem versões reais.
- **Depende de:** —

### 1.2 Definir o schema do `meta.json` por versão ([#4](https://github.com/Projeto-Euaggelion/biblia.publica/issues/4))
- **Tamanho:** P
...
### 1.3 Script para gerar/atualizar `meta.json` ([#5](https://github.com/Projeto-Euaggelion/biblia.publica/issues/5))
- **Tamanho:** M
...
- **Critérios de aceite:** script roda localmente sem erro sobre as 4 versões atuais; campos calculáveis batem com a contagem real dos arquivos.
- **Depende de:** 1.2

### 1.4 Gerar `meta.json` para as versões existentes ([#6](https://github.com/Projeto-Euaggelion/biblia.publica/issues/6))
- **Tamanho:** P
- **Descrição:** Rodar `gerar_meta.py` e preencher manualmente os campos não-automáticos (base textual, idioma/dialeto, anomalias conhecidas) para `blivre`, `jfaal`, `nt-a1819a`, `nva`.
- **Critérios de aceite:** as 4 pastas têm `meta.json` válido conforme o schema de 1.2.
- **Depende de:** 1.3

### 1.5 Script de validação de estrutura ([#7](https://github.com/Projeto-Euaggelion/biblia.publica/issues/7))
- **Tamanho:** M
...
- **Critérios de aceite:** script roda sobre as 4 versões existentes e retorna erro/exit code não-zero se encontrar problema; relatório legível no terminal.
- **Depende de:** —

### 1.6 Relatório de diferenças entre XML e JSON ([#8](https://github.com/Projeto-Euaggelion/biblia.publica/issues/8))
- **Tamanho:** M
...
- **Critérios de aceite:** rodando sobre as 4 versões, reporta divergência zero (ou lista exatamente as divergências conhecidas).
- **Depende de:** —

### 1.7 Integrar validação ao CI ([#9](https://github.com/Projeto-Euaggelion/biblia.publica/issues/9))
- **Tamanho:** P
...
- **Critérios de aceite:** tabela cobre as 4 versões atuais e é referenciada no README.
- **Depende de:** —
...
- **Critérios de aceite:** documento gerado automaticamente por `scripts/gerar_comparacao.py`, cobrindo as 4 versões; referenciado no README.
- **Depende de:** —
...
### 2.1 JSON Schema formal ([#12](https://github.com/Projeto-Euaggelion/biblia.publica/issues/12))
- **Tamanho:** M
...
### 2.2 XSD formal ([#13](https://github.com/Projeto-Euaggelion/biblia.publica/issues/13))
- **Tamanho:** M
...
### 2.3 Formato SQLite ([#14](https://github.com/Projeto-Euaggelion/biblia.publica/issues/14))
- **Tamanho:** M
...
- **Critérios de aceite:** `.sqlite` gerado para as 4 versões, schema documentado, uma query de exemplo (buscar um versículo) funciona.
- **Depende de:** —

### 2.4 `index.json` (API estática) ([#15](https://github.com/Projeto-Euaggelion/biblia.publica/issues/15))
- **Tamanho:** P
...
### 2.5 Guia de uso para desenvolvedores ([#16](https://github.com/Projeto-Euaggelion/biblia.publica/issues/16))
- **Tamanho:** M
...
### 2.6 Releases automatizados ([#17](https://github.com/Projeto-Euaggelion/biblia.publica/issues/17))
- **Tamanho:** M
...
### 2.7 Avaliar formato USFM ([#18](https://github.com/Projeto-Euaggelion/biblia.publica/issues/18))
- **Tamanho:** G
...
### 3.1 Issue templates específicos ([#19](https://github.com/Projeto-Euaggelion/biblia.publica/issues/19))
- **Tamanho:** P
...
### 3.2 Código de conduta e processo de decisão ([#20](https://github.com/Projeto-Euaggelion/biblia.publica/issues/20))
- **Tamanho:** P
...
### 3.3 Badges no README ([#21](https://github.com/Projeto-Euaggelion/biblia.publica/issues/21))
- **Tamanho:** P
...
### 3.4 CHANGELOG por versão ([#22](https://github.com/Projeto-Euaggelion/biblia.publica/issues/22))
- **Tamanho:** P
...
- **Critérios de aceite:** processo documentado; `CHANGELOG.md` inicial criado para as 4 versões existentes.
- **Depende de:** —

### 3.5 Monitoramento de fontes ([#23](https://github.com/Projeto-Euaggelion/biblia.publica/issues/23))
- **Tamanho:** G
...
### 3.6 Interface web simples (GitHub Pages) ([#24](https://github.com/Projeto-Euaggelion/biblia.publica/issues/24))
- **Tamanho:** G
...
### 3.7 Seção "Quem usa" no README ([#25](https://github.com/Projeto-Euaggelion/biblia.publica/issues/25))
- **Tamanho:** P
