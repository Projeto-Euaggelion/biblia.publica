...
<!-- O que este PR adiciona ou altera? Se for uma nova versão bíblica, informe o nome dela. -->

## Licenciamento (obrigatório para novas versões bíblicas)

- **Fonte original:** <!-- link do repositório/site de onde o texto foi obtido -->
- **Licença:** <!-- ex: domínio público, CC BY-SA 4.0, CC BY-ND 4.0, etc. -->
- **Onde a licença está declarada na fonte:** <!-- link para o arquivo LICENSE, página de direitos autorais, etc. -->
...
<!-- Qualquer contexto extra que ajude na revisão -->
